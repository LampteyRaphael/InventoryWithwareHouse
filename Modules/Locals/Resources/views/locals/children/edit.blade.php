...
@section('content')
    <div class="row">
            ...
            <div class="panel-body">
                ...
                <div class="col-sm-4" id="parent1" >
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-user"></i></div>
                            {!! Form::text('parentGuardianName',$childrenParent2,['class'=>'form-control']) !!}
                        </div>
                    </div>
                </div>
                <div class="col-sm-4" id="parent2">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fa fa-user"></i></div>
                            {!! Form::select('parentGuardianName2',[''=>'--Choose Option--']+$parents,null,['class'=>'form-control']) !!}
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
        ...
        <div class="panel mb0 shadow" id="step6">
            <div class="panel-heading border">
                <ol class="breadcrumb mb0 no-padding">
                    <li>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::number('members_id',substr($user->members_id,6,10),['class'=>'form-control','required'=>'required', 'placeholder'=>'' . "+3-digit only" ]) !!}
                            </div>
                        </div>
                    </div>
