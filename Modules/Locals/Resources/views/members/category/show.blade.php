...
@section('content')
    ...
    <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group ">
                        ...
                        <div class="input-group">
                            ...
                            {!! Form::number('amount',$income->amount,['class'=>'form-control','required'=>'required','step'=>'any']) !!}
      ...
      <script>
            ...
            {
                var x = confirm("You will be responsible for changing this amount. If yes click Ok else Cancel");
                if (x)
                    return true;
                else
                    return false;
