...
@section('content')
    ...
    <div class="collapse" id="statement">
        ...
        <div class="panel">
            <div class="panel-heading">{{Carbon\Carbon::parse($date)->format('F,Y')}} Income Statement</div>
    ...
    <div class="panel shadow animated slideInDown">
        ...
        <div class="panel-heading border">
            <ol class="breadcrumb mb0 no-padding">
                <li>
                    <a href="" class="btn btn-default btn-xs" data-toggle="modal" data-target="#date"><i class="fa fa-calendar"></i>Click Here To Change Date</a>
                </li>
                <li>
                    {{Carbon\Carbon::parse($date)->format('F,Y')}}
                </li>
                <li><a class="btn btn-primary btn-xs" href="#statement" data-toggle="collapse">Statement</a></li>
                <li><a class="btn btn-danger btn-xs" href="{{route('monthlyPdf.index',$date)}}"><i class="fa fa-print"></i>Print</a></li>
            ...
            <div class="table-responsive">
                @if($incomeCategory)
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            <td>Total</td>
                            <td>{{number_format($totals=$incomeCategoryTotal+$totalTithe+$donation,2)}}</td>
                        </tr>
                        </tbody>
                    </table>
                @endif
