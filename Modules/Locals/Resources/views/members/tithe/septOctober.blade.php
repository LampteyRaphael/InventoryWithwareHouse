...
@section('content')
    ...
    {!! Form::open(['method'=>'POST','action'=>'Locals\TitheController@septOctoberPost','class'=>'modal form-row','id'=>'date', 'tabindex'=>'-1','aria-hidden'=>'true','role'=>'dialog'] ) !!}
            ...
            <div class="panel mb25">
                <div class="panel-heading border">
                    <ol class="breadcrumb mb0 no-padding">
                        <li>{{$year}}</li>
                        <li>
                            <a  href="javascript:;" >SEPTEMBER-OCTOBER</a>
                        </li>
                        ...
                        <li>
                            <a class="btn btn-danger btn-xs" href="{{route('excelSO',$year)}}">Export to Excel</a>
                        </li>
                    </ol>
                </div>
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            <thead>
                            <tr>
                                <th colspan="7" class="text-center">SEPTEMBER</th>
                                <th colspan="7" class="text-center">OCTOBER</th>
                            </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if (   number_format(
                                                    ...
                                                    ->whereYear('created_at',$year)->whereMonth('created_at',$a)
                                                      ->whereDay('created_at','>=',1)->whereDay('created_at','<=',5)
                                            ...
                                            <td>
                                                @if (   number_format(
                                                 App\PostTithe::orderBy('created_at','asc')->where('user_id', $user_id->id)
                                                 ->whereYear('created_at',$year)->whereMonth('created_at',$a)
                                                  ->whereDay('created_at','>=',6)->whereDay('created_at','<=',12)
                                               ->where('local_id', Auth::user()->local_id)->pluck('amount')->sum(),2)==0.00)
                                            ...
                                            <td>
                                              ...
                                              App\PostTithe::orderBy('created_at','asc')->where('user_id', $user_id->id)
                                              ->whereYear('created_at',$year)->whereMonth('created_at',$a)
                                                ->whereDay('created_at','>=',13)->whereDay('created_at','<=',19)
                                            ->where('local_id', Auth::user()->local_id)->pluck('amount')->sum(),2)==0.00)
                                           ...
                                           App\PostTithe::orderBy('created_at','asc')->where('user_id', $user_id->id)
                                           ->whereYear('created_at',$year)->whereMonth('created_at',$a)
                                             ->whereDay('created_at','>=',20)->whereDay('created_at','<=',26)
                                         ->where('local_id', Auth::user()->local_id)->pluck('amount')->sum(),2)==0.00)
                                            ...
                                            App\PostTithe::orderBy('created_at','asc')->where('user_id', $user_id->id)
                                            ->whereYear('created_at',$year)->whereMonth('created_at',$a)
                                              ->whereDay('created_at','>=',27)->whereDay('created_at','<=',30)
                                          ->where('local_id', Auth::user()->local_id)->pluck('amount')->sum(),2)==0.00)
